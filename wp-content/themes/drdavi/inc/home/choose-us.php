<section class="choose-us">
    <div class="row">
        <div class="why-choose-container col-sm-6 pt-90">
            <div class="why-choose">
                ...
                <ul class="why-choose-list">
                    <li><span>01</span>
                        <h5>ESCOLHA CERTO</h5>
                        <p>Doutor especialista na maior faculdade das américas e do mundo a Universidade de São Paulo, tenha o tratamento mais moderno.</p>
                    </li>
                    <li><span>02</span>
